...
extension AssetAllocationTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__AssetAllocationTests = [
        ("testAverageReturnRate", testAverageReturnRate),
        ("testInit", testInit),
    ]
}
...
extension HoldingTests {
    ...
    static let __allTests__HoldingTests = [
        ...
        ("testReturnOnInvestment", testReturnOnInvestment),
